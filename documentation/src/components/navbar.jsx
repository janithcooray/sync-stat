...
export default function Navbar() {
  return (
    <nav className="relative flex w-screen flex-wrap items-center justify-between px-0 py-3 bg-white mb-3">
      <div className=" px-4 mx-auto w-screen flex flex-wrap items-center justify-between">
        ...
        >
          ...
          <div className="relative flex w-full sm:w-7/12 md:w-3/12 px-4 w-11 rounded-full flex-wrap items-stretch lg:ml-auto">
            <input
              type="text"
              className="px-2 py-1 h-8 border border-solid  border-stone-600 rounded-full text-sm leading-snug text-stone-700 bg-stone-100 shadow-none outline-none focus:outline-none w-24 font-normal flex-1 placeholder-stone-300 text-center"
              placeholder="Search"
            />
          </div>
        </div>
